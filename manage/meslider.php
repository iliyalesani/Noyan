...
?>
 <?php
		$dbResult = mysql_query("SELECT * FROM mtblslider WHERE  ID = ".$product_id,$dlink);
...
<div id="main_column" >
<div class="mgbox">ویرایش اسلایدر</div>
 <!--**********************************************main***************************************-->  
...
<form action="updateslider.php" method="post" style="font-size:16px; line-height:22px;"  enctype="multipart/form-data">
...
<table width="100%" bordercolor="#cccccc"  border="1" rules="rows" cellpadding="5" >
  ...
  <tr>
    <td>توضیحات:</td>
    <td><textarea name="shorttext"   class="formstyle2"  style="width:500px; height:100px;	" ><?php echo $sub['shorttext'] ?></textarea></td>
  </tr>
    <tr>
    <td>عکس قبلی:</td>
