...
<div id="main_column" >
<div class="mgbox">درج دانلود</div>
 <!--**********************************************main***************************************-->      
...
<form action="savedownload.php" method="post" style="font-size:16px; line-height:22px;"  enctype="multipart/form-data">
<br />
...
?>
        ...
        <tr>
    <td>مبلغ:</td>
    <td><input type="text"  name="price"  id="price"  class="formstyle2" value="0" style="width:400px;" /></td>
  </tr>
        <tr>
    <td>دانلود اول:</td>
   
    <td > فایل:&nbsp;<input type="hidden" name="MAX_FILE_SIZE" value="90000000"  /><input name="fd1" type="file"  id="fd1"/>&nbsp;&nbsp;&nbsp;
  تیتر:&nbsp;<input type="text"  name="td1"  class="formstyle2"  style="width:180px;" />&nbsp;&nbsp;&nbsp;
    رمز:&nbsp;<input type="text"  name="tr1"  class="formstyle2"  style="width:180px;" />
  ...
  تیتر:&nbsp;<input type="text"  name="td2"  class="formstyle2"  style="width:180px;" />&nbsp;&nbsp;&nbsp;
    رمز:&nbsp;<input type="text"  name="tr2"  class="formstyle2"  style="width:180px;" />
  ...
  تیتر:&nbsp;<input type="text"  name="td3"  class="formstyle2"  style="width:180px;" />&nbsp;&nbsp;&nbsp;
    رمز:&nbsp;<input type="text"  name="tr3"  class="formstyle2"  style="width:180px;" />
