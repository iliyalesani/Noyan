...
VALUES (
NULL ,  '".$_POST['titr']."',  'images/advertise/".$filename."','".$_POST['link']."',  '".$_POST['type']."'  );";

						 mysql_query($sql,$dlink);
						 ?>
						<script type="text/javascript" >
  window.location='manage.php?type=9&msg=تبلیغ  مورد نظر با موفقیت ثبت شد';
  </script>		 
  <?php
}
else
{
							 ?>
						<script type="text/javascript" >
  window.location='manage.php?type=9&msg=خطا';
  </script>		 
  <?php
